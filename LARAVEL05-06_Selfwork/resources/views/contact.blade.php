<x-main>
    ...
    <h2 class="text-center fs-1 m-4">- RICHIEDI INFORMAZIONI -</h2>
    <div class="container-fluid h-65 mt-3 mb-4 d-flex justify-content-center">
        <div class="col-8 col-sm-6 col-md-5 col-lg-4 col-xl-3">
            ...
            <form action="{{ route('send') }}" method="POST">
                ...
                <!-- Telefono -->
                <div class="mb-3">
                    <input id="phone" name="phone" class="form-control" type="text" placeholder="Telefono"
                        value="{{ old('phone') }}" />
                </div>
                <!-- Email -->
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <select id="corso" name="corso" class="form-select">
                        <option @if (!old('corso')) selected @endif value="">Scegli il corso...
                        </option>
                        <option @if (old('corso') == 'weightlifting') selected @endif value="weightlifting">Weightlifting
                        </option>
                ...
                <!-- Messaggio -->
                <div class="mb-3">
                    <textarea id="message" name="message" class="form-control" type="text" placeholder="Messaggio"
